    ...
    <section id='home' className='mb-28 max-w-[50rem] text-center sm:mb-0'>
      <div className='flex items-center justify-center'>
        <div className='relative'>
          ...
          >
            <Image src="https://media.licdn.com/dms/image/v2/D4E03AQHtI700FkT4yA/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1691343076811?e=1738195200&v=beta&t=HOtyW8FuEl4MoXUWlVNYEyGs11wcrS3l_ezDXPXrFts"
              alt='Santiago'
              width="192"
              height="192"
              quality="95"
          ...
          <motion.span className='text-4xl absolute bottom-0 right-[-1rem]'
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ 
              type: 'spring',
